        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="text-right">
                <a href="{{ route('cetak_menu') }}" class="btn btn-primary btn-sm float-leftt">
            ...
            <div class="card-body">
              <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <tr>
                    ...
                    <td>
                      <form action="{{ route('menu.destroy', $hasil->id) }}" method="POST">
                        @csrf
                        @method('delete')
                        <a href="{{ route('menu.edit', $hasil->id ) }}" class="btn btn-info btn-sm">
