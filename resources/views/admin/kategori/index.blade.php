        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="text-right">
                <a href="{{ route('kategori.create') }}" class="btn btn-success btn-sm float-leftt">
                ...
                <tr>
                    ...
                    <td>
                      <form action="{{ route('kategori.destroy', $hasil->id) }}" method="POST">
                        @csrf
                        @method('delete')
                        <a href="{{ route('kategori.edit', $hasil->id ) }}" class="btn btn-info btn-sm">
