            		...
            		<thead>
                      ...
                      @if($errors->has('nama_bahan'))
                        <div class="alert alert-danger alert-dismissible">
                          ...
                          <strong>{{ $errors->first('nama_bahan') }}</strong>
                        </div>
                      @endif
                    		<label >Nama Bahan</label>
                    		<input name="nama_bahan" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Bahan" value="">
               			 </div>
                     <div class="form-group">
