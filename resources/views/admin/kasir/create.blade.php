...
@section('sub-judul','Tambah Kasir')
@section('jejak','Tambah Kasir')
@section('content')
                ...
                <thead>
                    ...
                    <div class="form-group">
                      ...
                      @endif
                        ...
                        <input name="nama_kasir" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nama Kasir" value="">
                     </div>
                     <div class="form-group">
